package com.example.jawaclinicnew.auth;

import com.example.jawaclinicnew.config.JwtService;
import com.example.jawaclinicnew.repository.UserJpaRepo;
import com.example.jawaclinicnew.requestBody.RegisterRequest;
import com.example.jawaclinicnew.token.Token;
import com.example.jawaclinicnew.token.TokenRepository;
import com.example.jawaclinicnew.token.TokenType;
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
      ...
      return AuthenticationResponse.builder()
              .accessToken(jwtToken)
              .refreshToken(refreshToken)
              .userId(user.getUserID()) // Include user ID in the response
              .build();
    }
